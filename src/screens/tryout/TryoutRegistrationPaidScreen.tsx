...
type TryoutRegistrationPaidRouteProp = RouteProp<RootStackParamList, 'TryoutRegistrationPaid'>;
...
const paymentUploadHelper = 'Upload di sini';
...
const TryoutRegistrationPaidScreen: FC = () => {
	...
	const uploadCardHeight = useMemo(
		() => clamp(layout.horizontalPadding * 5, 120, 140),
		[layout.horizontalPadding]
	);
					...
					>
						...
						<View style={{ rowGap: inputSpacing, gap: inputSpacing }}>
							...
							<Pressable
								...
								accessibilityRole="button"
								accessibilityLabel="Unggah bukti pembayaran"
							>
								<Text style={styles.uploadTitle}>Bukti Pembayaran</Text>
...
export default TryoutRegistrationPaidScreen;
